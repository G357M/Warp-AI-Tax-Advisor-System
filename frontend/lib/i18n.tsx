...
const DICT: Record<string, Entry> = {
  ...
  'footer.legal': { ru: 'Правовая информация', ka: 'იურიდიული ინფორმაცია', en: 'Legal' },
  'legal.terms': { ru: 'Условия использования', ka: 'გამოყენების პირობები', en: 'Terms of use' },
  'legal.refunds': { ru: 'Возврат и отмена', ka: 'თანხის დაბრუნება', en: 'Refunds and cancellation' },
  'legal.privacy': { ru: 'Конфиденциальность', ka: 'კონფიდენციალურობა', en: 'Privacy policy' },
  'legal.delivery': { ru: 'Активация доступа', ka: 'წვდომის გააქტიურება', en: 'Access activation' },
  'legal.contact': { ru: 'Реквизиты и контакты', ka: 'რეკვიზიტები და კონტაქტი', en: 'Legal details and contact' },
  ...
  'chat.err.auth': {
    ru: 'Сессия закончилась. Войдите снова — новый вопрос не был списан из лимита.',
    ka: 'სესია დასრულდა. შედით თავიდან — ახალი კითხვა ლიმიტიდან არ ჩამოჭრილა.',
    en: 'Your session ended. Sign in again — this question was not charged to your limit.',
  },
  'chat.err.signin': { ru: 'Войти снова', ka: 'ხელახლა შესვლა', en: 'Sign in again' },
  ...
  'pricing.month': { ru: '/30 дней', ka: '/30 დღე', en: '/30 days' },
  ...
  'pricing.note': {
    ru: 'Окончательная цена за 30 дней. Без автопродления. Оплата в кабинете по счёту или через TBC после активации банка.',
    ka: 'საბოლოო ფასი 30 დღისთვის. ავტომატური განახლების გარეშე. გადახდა კაბინეტში ინვოისით ან ბანკის გააქტიურების შემდეგ TBC-ით.',
    en: 'Final price for 30 days. No automatic renewal. Pay in the account by invoice or through TBC once bank activation is complete.',
  },
  'plan.free.tagline': { ru: 'Познакомиться с сервисом', ka: 'სერვისის გასაცნობად', en: 'Get to know the service' },
  'plan.free.f1': { ru: '5 вопросов в день после регистрации', ka: 'რეგისტრაციის შემდეგ დღეში 5 კითხვა', en: '5 questions a day with an account' },
  ...
  'plan.pro.f3': { ru: 'Статистика налоговых споров', ka: 'საგადასახადო დავების სტატისტიკა', en: 'Tax dispute statistics' },
  'plan.pro.f4': { ru: 'История изменений законов', ka: 'კანონების ცვლილებების ისტორია', en: 'Law-change history' },
  ...
  'plan.business.f2': { ru: 'Оплата по счёту для компании', ka: 'კომპანიისთვის ინვოისით გადახდა', en: 'Company invoice payment' },
  ...
  'acc.subtitle': {
    ru: 'Управляйте пакетом, оплатой и сохранёнными юридическими ответами в одном месте.',
    ka: 'მართეთ პაკეტი, გადახდები და შენახული სამართლებრივი პასუხები ერთ სივრცეში.',
    en: 'Manage your plan, billing, and saved legal answers in one place.',
  },
  ...
  'acc.no_auto_renew': {
    ru: 'Автопродление выключено: следующий период не будет оплачен без вашего подтверждения.',
    ka: 'ავტომატური განახლება გამორთულია: შემდეგი პერიოდი თქვენი თანხმობის გარეშე არ ჩამოიჭრება.',
    en: 'Auto-renewal is off: the next period will not be charged without your confirmation.',
  },
  'acc.status.active': { ru: 'Активен', ka: 'აქტიური', en: 'Active' },
  'acc.status.past_due': { ru: 'Ожидает оплаты', ka: 'გადახდას ელოდება', en: 'Payment due' },
  'acc.status.canceled': { ru: 'Отменён', ka: 'გაუქმებული', en: 'Cancelled' },
  'acc.upgrade_pro': { ru: 'Перейти на Pro', ka: 'Pro-ზე გადასვლა', en: 'Upgrade to Pro' },
  'acc.upgrade_error': { ru: 'Не удалось подготовить оплату. Попробуйте ещё раз.', ka: 'გადახდის მომზადება ვერ მოხერხდა. სცადეთ თავიდან.', en: 'Could not prepare checkout. Please try again.' },
  'acc.checkout_instructions': {
    ru: 'Тариф {plan} — {amount} за 30 дней. Напишите на {email}: выставим счёт и активируем доступ после подтверждения поступления.',
    ka: '{plan} ტარიფი — {amount} 30 დღისთვის. მოგვწერეთ {email}-ზე: გამოგიგზავნით ინვოისს და თანხის მიღების დადასტურების შემდეგ წვდომას გავააქტიურებთ.',
    en: '{plan} plan — {amount} for 30 days. Email {email}; we will issue an invoice and activate access after confirming receipt.',
  },
  ...
  'acc.quota_resets': { ru: 'Лимит обновится завтра', ka: 'ლიმიტი ხვალ განახლდება', en: 'The limit resets tomorrow' },
  'acc.manage_plan': { ru: 'Пакет и возможности', ka: 'პაკეტი და შესაძლებლობები', en: 'Plan and features' },
  'acc.manage_plan_hint': {
    ru: 'Цена фиксируется в заявке, а статус оплаты и срок подписки сохраняются в кабинете.',
    ka: 'ფასი განაცხადში ფიქსირდება, ხოლო გადახდის სტატუსი და გამოწერის ვადა კაბინეტში ინახება.',
    en: 'The price is fixed in each request, while payment status and subscription dates stay in your account.',
  },
  'acc.pricing_preliminary': { ru: 'Цены предварительные', ka: 'ფასები წინასწარია', en: 'Preliminary pricing' },
  'acc.pricing_final': { ru: 'Окончательная цена · 30 дней · без автопродления', ka: 'საბოლოო ფასი · 30 დღე · ავტომატური განახლების გარეშე', en: 'Final price · 30 days · no automatic renewal' },
  'acc.free_price': { ru: 'Бесплатно', ka: 'უფასოდ', en: 'Free' },
  'acc.current_plan': { ru: 'Текущий пакет', ka: 'მიმდინარე პაკეტი', en: 'Current plan' },
  'acc.renew_plan': { ru: 'Продлить', ka: 'გაგრძელება', en: 'Renew' },
  'acc.included': { ru: 'Уже включено', ka: 'უკვე შედის', en: 'Already included' },
  'acc.choose_plan': { ru: 'Выбрать {plan}', ka: '{plan}-ის არჩევა', en: 'Choose {plan}' },
  'acc.buy_plan': { ru: 'Оплатить {plan} — {amount}', ka: '{plan}-ის გადახდა — {amount}', en: 'Pay for {plan} — {amount}' },
  'acc.checkout_creating': { ru: 'Создаю заявку…', ka: 'განაცხადი იქმნება…', en: 'Creating request…' },
  'acc.payment_methods': { ru: 'Способы оплаты', ka: 'გადახდის მეთოდები', en: 'Payment methods' },
  'acc.payment_methods_hint': {
    ru: 'Выберите способ до создания заявки. Онлайн-оплата показывается доступной только при полностью настроенном merchant-аккаунте.',
    ka: 'განაცხადის შექმნამდე აირჩიეთ გადახდის მეთოდი. ონლაინ გადახდა ხელმისაწვდომად მხოლოდ სრულად გამართული merchant-ანგარიშის შემთხვევაში გამოჩნდება.',
    en: 'Choose a method before creating a request. Online checkout appears available only with a complete merchant setup.',
  },
  'acc.method_jump': { ru: 'Выбранный способ оплаты можно изменить ниже.', ka: 'არჩეული გადახდის მეთოდის შეცვლა ქვემოთ შეგიძლიათ.', en: 'You can change the selected payment method below.' },
  'acc.legal_title': { ru: 'Подтверждение перед оплатой', ka: 'დადასტურება გადახდამდე', en: 'Confirmation before payment' },
  'acc.legal_terms_accept': { ru: 'Я принимаю Условия использования и ознакомился с Политикой конфиденциальности, возврата и активации доступа.', ka: 'ვეთანხმები გამოყენების პირობებს და გავეცანი კონფიდენციალურობის, თანხის დაბრუნებისა და წვდომის გააქტიურების პოლიტიკებს.', en: 'I accept the Terms of use and have read the Privacy, Refund, and Access activation policies.' },
  'acc.legal_immediate': { ru: 'Прошу начать цифровую услугу сразу после подтверждения оплаты. Я понимаю, что законные исключения из права на отказ применяются только при предусмотренных законом условиях; добровольная 24-часовая гарантия сохраняется.', ka: 'ვითხოვ ციფრული მომსახურების დაწყებას გადახდის დადასტურებისთანავე. მესმის, რომ უარის უფლების კანონით დადგენილი გამონაკლისები მხოლოდ კანონით გათვალისწინებულ პირობებში მოქმედებს; ნებაყოფლობითი 24-საათიანი გარანტია ძალაში რჩება.', en: 'I request the digital service to start as soon as payment is confirmed. I understand that statutory exceptions to withdrawal apply only under the conditions set by law; the voluntary 24-hour guarantee remains available.' },
  'acc.legal_read': { ru: 'Открыть документы', ka: 'დოკუმენტების გახსნა', en: 'Open documents' },
  'acc.method.manual.title': { ru: 'Счёт и банковский перевод', ka: 'ინვოისი და საბანკო გადარიცხვა', en: 'Invoice and bank transfer' },
  'acc.method.manual.hint': { ru: 'Для физических и юридических лиц; активация после подтверждения поступления.', ka: 'ფიზიკური და იურიდიული პირებისთვის; აქტივაცია თანხის მიღების დადასტურების შემდეგ.', en: 'For individuals and companies; activation follows payment confirmation.' },
  'acc.method.tbc.title': { ru: 'TBC E-Commerce', ka: 'TBC E-Commerce', en: 'TBC E-Commerce' },
  'acc.method.tbc.hint': { ru: 'Оплата картой проходит на защищённой странице TBC; данные карты Tax Advisor не получает.', ka: 'ბარათით გადახდა TBC-ის დაცულ გვერდზე სრულდება; Tax Advisor ბარათის მონაცემებს არ იღებს.', en: 'Card payment runs on TBC’s hosted page; Tax Advisor never receives card details.' },
  'acc.method.bog.title': { ru: 'Bank of Georgia Online Payments', ka: 'Bank of Georgia Online Payments', en: 'Bank of Georgia Online Payments' },
  'acc.method.bog.hint': { ru: 'Карты и сохранённые способы оплаты после merchant-проверки.', ka: 'ბარათები და შენახული გადახდის მეთოდები merchant-შემოწმების შემდეგ.', en: 'Cards and saved payment methods after merchant verification.' },
  'acc.method.available': { ru: 'Доступно', ka: 'ხელმისაწვდომია', en: 'Available' },
  'acc.method.preparing': { ru: 'Требует подключения', ka: 'საჭიროებს მიერთებას', en: 'Setup required' },
  'acc.method.select': { ru: 'Выбрать', ka: 'არჩევა', en: 'Select' },
  'acc.method.selected': { ru: 'Выбрано', ka: 'არჩეულია', en: 'Selected' },
  'acc.billing_error': { ru: 'Не удалось загрузить состояние оплаты.', ka: 'გადახდის მდგომარეობა ვერ ჩაიტვირთა.', en: 'Could not load billing status.' },
  'acc.checkout_ready': { ru: 'Заявка на оплату создана', ka: 'გადახდის განაცხადი შექმნილია', en: 'Payment request created' },
  'acc.checkout_online_instructions': {
    ru: 'Тариф {plan} — {amount} за 30 дней. Завершите оплату на странице банка; доступ активируется только после серверной проверки статуса.',
    ka: '{plan} ტარიფი — {amount} 30 დღისთვის. დაასრულეთ გადახდა ბანკის გვერდზე; წვდომა მხოლოდ სტატუსის სერვერული შემოწმების შემდეგ გააქტიურდება.',
    en: '{plan} plan — {amount} for 30 days. Complete payment on the bank page; access activates only after server-side status verification.',
  },
  'acc.checkout_review_title': { ru: 'Оплата требует проверки', ka: 'გადახდა შემოწმებას საჭიროებს', en: 'Payment needs review' },
  'acc.checkout_review_hint': {
    ru: 'Автоматическая активация остановлена: состояние провайдера неоднозначно или не совпало с заявкой. Повторное списание не выполнялось.',
    ka: 'ავტომატური აქტივაცია შეჩერებულია: პროვაიდერის მდგომარეობა ბუნდოვანია ან განაცხადს არ ემთხვევა. განმეორებითი ჩამოჭრა არ შესრულებულა.',
    en: 'Automatic activation stopped because provider state is ambiguous or does not match the request. No retry charge was attempted.',
  },
  'acc.checkout_reference': { ru: 'Номер заявки', ka: 'განაცხადის ნომერი', en: 'Request reference' },
  'acc.checkout_expires': { ru: 'действует до {d}', ka: 'მოქმედებს {d}-მდე', en: 'valid until {d}' },
  'acc.request_invoice': { ru: 'Запросить счёт', ka: 'ინვოისის მოთხოვნა', en: 'Request invoice' },
  'acc.continue_to_bank': { ru: 'Перейти к оплате', ka: 'გადახდაზე გადასვლა', en: 'Continue to payment' },
  'acc.check_payment': { ru: 'Проверить оплату', ka: 'გადახდის შემოწმება', en: 'Check payment' },
  'acc.provider_status': { ru: 'Статус банка', ka: 'ბანკის სტატუსი', en: 'Bank status' },
  'acc.payment_return.checking': { ru: 'Проверяю статус непосредственно в банке…', ka: 'სტატუსი უშუალოდ ბანკში მოწმდება…', en: 'Checking status directly with the bank…' },
  'acc.payment_return.paid': { ru: 'Оплата подтверждена, подписка активирована.', ka: 'გადახდა დადასტურდა და გამოწერა გააქტიურდა.', en: 'Payment confirmed and subscription activated.' },
  'acc.payment_return.pending': { ru: 'Банк ещё обрабатывает оплату. Статус можно проверить повторно.', ka: 'ბანკი გადახდას ჯერ კიდევ ამუშავებს. სტატუსის ხელახლა შემოწმება შეგიძლიათ.', en: 'The bank is still processing the payment. You can check again.' },
  'acc.payment_return.review': { ru: 'Автоматическая активация остановлена для ручной проверки.', ka: 'ავტომატური აქტივაცია ხელით შემოწმებისთვის შეჩერდა.', en: 'Automatic activation stopped for manual review.' },
  'acc.payment_return.error': { ru: 'Не удалось проверить банк. Списание повторно не запускалось.', ka: 'ბანკის შემოწმება ვერ მოხერხდა. განმეორებითი ჩამოჭრა არ დაწყებულა.', en: 'Could not reach the bank. No retry charge was started.' },
  'acc.support_email_pending': { ru: 'служебный email', ka: 'სამსახურის ელფოსტა', en: 'support email' },
  'acc.billing_history': { ru: 'История оплат', ka: 'გადახდების ისტორია', en: 'Payment history' },
  'acc.billing_history_hint': { ru: 'Только подтверждённые операции без банковских реквизитов.', ka: 'მხოლოდ დადასტურებული ოპერაციები საბანკო დეტალების გარეშე.', en: 'Confirmed transactions only, without bank details.' },
  'acc.billing_loading': { ru: 'Загружаю операции…', ka: 'ოპერაციები იტვირთება…', en: 'Loading transactions…' },
  'acc.billing_empty': { ru: 'Подтверждённых оплат пока нет.', ka: 'დადასტურებული გადახდები ჯერ არ არის.', en: 'No confirmed payments yet.' },
  'acc.payment.succeeded': { ru: 'Оплачено', ka: 'გადახდილია', en: 'Paid' },
  'acc.payment.pending': { ru: 'В обработке', ka: 'დამუშავებაშია', en: 'Processing' },
  'acc.payment.failed': { ru: 'Не оплачено', ka: 'არ არის გადახდილი', en: 'Not paid' },
  ...
  'acc.history': { ru: 'История диалогов', ka: 'დიალოგების ისტორია', en: 'Chat history' },
  'acc.history_locked': { ru: 'История доступна на тарифах Pro и Business.', ka: 'ისტორია ხელმისაწვდომია Pro და Business ტარიფებზე.', en: 'History is available on Pro and Business plans.' },
  'acc.history_hint': { ru: 'Открывайте прошлые ответы вместе с их официальными источниками.', ka: 'გახსენით წინა პასუხები მათ ოფიციალურ წყაროებთან ერთად.', en: 'Reopen earlier answers together with their official sources.' },
  'acc.history_loading': { ru: 'Загружаю историю…', ka: 'ისტორია იტვირთება…', en: 'Loading history…' },
  'acc.history_error': { ru: 'Не удалось загрузить историю.', ka: 'ისტორიის ჩატვირთვა ვერ მოხერხდა.', en: 'Could not load history.' },
  'acc.history_empty': { ru: 'Сохранённых диалогов пока нет.', ka: 'შენახული დიალოგები ჯერ არ არის.', en: 'No saved conversations yet.' },
  'acc.history_untitled': { ru: 'Диалог без названия', ka: 'უსათაურო დიალოგი', en: 'Untitled conversation' },
  'acc.history_detail_error': { ru: 'Не удалось открыть этот диалог.', ka: 'ამ დიალოგის გახსნა ვერ მოხერხდა.', en: 'Could not open this conversation.' },
  'acc.history_back': { ru: 'Назад в кабинет', ka: 'კაბინეტში დაბრუნება', en: 'Back to account' },
  'acc.history_delete': { ru: 'Удалить диалог', ka: 'დიალოგის წაშლა', en: 'Delete conversation' },
  'acc.history_delete_confirm': { ru: 'Удалить без возможности восстановления?', ka: 'წაიშალოს აღდგენის შესაძლებლობის გარეშე?', en: 'Delete permanently?' },
  'acc.history_deleting': { ru: 'Удаляю…', ka: 'იშლება…', en: 'Deleting…' },
  'acc.history_delete_yes': { ru: 'Да, удалить', ka: 'დიახ, წაშლა', en: 'Yes, delete' },
  'acc.history_delete_no': { ru: 'Отмена', ka: 'გაუქმება', en: 'Cancel' },
  'acc.history_advisor': { ru: 'Tax Advisor', ka: 'Tax Advisor', en: 'Tax Advisor' },
  'acc.history_you': { ru: 'Вы', ka: 'თქვენ', en: 'You' },
  ...
  'acc.bug_cancel': { ru: 'Закрыть форму', ka: 'ფორმის დახურვა', en: 'Close form' },
