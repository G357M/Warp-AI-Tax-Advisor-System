...
const DICT: Record<string, Entry> = {
  ...
  'acc.checkout_instructions': {
    ru: 'Тариф {plan} — {amount} ₾/мес. Напишите на {email}: выставим счёт и активируем подписку в течение рабочего дня.',
    ka: '{plan} ტარიფი — {amount} ₾/თვე. მოგვწერეთ {email}-ზე: გამოგიგზავნით ინვოისს და გამოწერას ერთი სამუშაო დღის განმავლობაში გავააქტიურებთ.',
    en: '{plan} plan — {amount} ₾/month. Email {email}; we will issue an invoice and activate the subscription within one business day.',
  },
