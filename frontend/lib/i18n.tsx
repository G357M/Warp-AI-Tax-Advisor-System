...
const DICT: Record<string, Entry> = {
  ...
  'acc.payment_methods_hint': {
    ru: 'Счёт и банковский перевод доступны сейчас. Онлайн-оплата появится только после безопасного подключения merchant-аккаунта.',
    ka: 'ინვოისი და საბანკო გადარიცხვა უკვე ხელმისაწვდომია. ონლაინ გადახდა მხოლოდ merchant-ანგარიშის უსაფრთხო მიერთების შემდეგ ჩაირთვება.',
    en: 'Invoice and bank transfer are available now. Online checkout will launch only after secure merchant onboarding.',
  },
  ...
  'acc.method.tbc.hint': { ru: 'Карты и будущие рекуррентные платежи после подключения магазина.', ka: 'ბარათები და სამომავლო რეგულარული გადახდები მაღაზიის გააქტიურების შემდეგ.', en: 'Cards and future recurring payments after merchant activation.' },
