...
const DICT: Record<string, Entry> = {
  ...
  'acc.checkout_instructions': {
    ru: 'Тариф {plan} — {amount} в месяц. Напишите на {email}: выставим счёт и активируем подписку в течение рабочего дня.',
    ka: '{plan} ტარიფი — თვეში {amount}. მოგვწერეთ {email}-ზე: გამოგიგზავნით ინვოისს და გამოწერას ერთი სამუშაო დღის განმავლობაში გავააქტიურებთ.',
    en: '{plan} plan — {amount} per month. Email {email}; we will issue an invoice and activate the subscription within one business day.',
  },
  ...
  'acc.checkout_online_instructions': {
    ru: 'Тариф {plan} — {amount} в месяц. Завершите оплату на странице банка; подписка активируется только после серверной проверки статуса.',
    ka: '{plan} ტარიფი — თვეში {amount}. დაასრულეთ გადახდა ბანკის გვერდზე; გამოწერა მხოლოდ სტატუსის სერვერული შემოწმების შემდეგ გააქტიურდება.',
    en: '{plan} plan — {amount} per month. Complete payment on the bank page; the subscription activates only after server-side status verification.',
  },
