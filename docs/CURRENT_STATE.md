...
35. **Parser-backed legal answers now share one scalable article contract.** The factory contains 25 expert-authored contracts / 75 RU/EN/KA answers and 28 verified article bindings. Tax residency, late-payment interest, tax appeals and LLC small-business ineligibility no longer keep independent answer text in legacy guards: articles 34, 272, 296/297/299 and 88/90 are generated from the same contract used by direct routing, the final citation boundary and the public canary. Each contract declares its exact parser goal, so eligibility or procedure rules cannot overwrite ordinary rate routing. A deterministic audit rejects duplicate match signatures, missing anchors or localized facts and a generated 75-request suite remains dry-run-first, loopback-only and manually executed because public responses may invoke the provider.
