...
- отдельное ручное exact-ID retirement уже атрибутированных старых InfoHub records в host-wide `default` builder; nightly audit остаётся observe-only и global prune запрещён;
