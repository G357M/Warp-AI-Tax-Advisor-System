...
Для Налогового кодекса точная норма теперь означает также проверенную прямую
ссылку на конкретную статью в актуальном официальном документе Matsne, а не
только ссылку на кодекс целиком. Версионированный реестр содержит 354 article
anchors из публикации 245; общий API-контракт допускает такие же проверенные
Matsne provision links для других законов и постановлений и отклоняет
неофициальные URL.
